    ...
    <>
      ...
      <article>
        <section>
          ...
          <div>           
			There is also the <A class="underline font-bold" href="/playground">Layout Playground</A>. This lets you:
			<ul class="list-disc pl-8">
              ...
              <li>
                Choose from a variety of languages and layouts.
                More will be added sometime in the future!
              </li>
			</ul>
          </div>
        </section>
